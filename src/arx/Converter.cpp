...
// -------------------------------------------------------------------------- //
		...
		unsigned int getCPId(const char* cpName) {
			...
			if(c == "DEFAULT")
				return CP_ACP;
			else if(c == "CSPC8CODEPAGE437")
				return 437;
			else if(c == "ASMO-708")
				return 708;
			else if(c == "ASMO_449" || c == "CSISO89ASMO449")
				return 709;
			// 710 Arabic - Transparent Arabic 
			// 720 Arabic - Transparent ASMO 
			else if(c == "CSPC775BALTIC")
				return 775;
			else if(c == "CSPC850MULTILINGUAL")
				return 850;
			else if(c == "CSPCP852")
				return 852;
			// 858 OEM - Multilingual Latin I + Euro symbol 
			// Duh... muri da yo... 
			else if(c == "IBM-932" || c == "CSSHIFTJIS" || c == "SHIFT-JIS" || c == "SHIFT_JIS" || c == "SJIS-OPEN" || c == "SJIS-WIN" || c == "SJIS")
				return 932;
			else if(c == "WINDOWS-936") // ANSI/OEM - Simplified Chinese (PRC, Singapore)
				return 936;
			else if(c == "MSCP949") // ANSI/OEM - Korean (Unified Hangul Code)
				return 949;
			else if(c == "WINDOWS-1251" )
				return 1251;
			else if(c == "CSKOI8R" || c == "KOI8-R" || c == "KOI8R")
				return 20866;
			else if(c == "CSGB2312" || c == "GB2312") // Simplified Chinese (GB2312) 
				return 20936;
			else if(c == "EUCJP" || c == "EUCJP-MS" || c == "EUCJP-OPEN" || c == "EUCJP-WIN" || c == "EUC-JP-MS" || c =="EUC-JP")
				return 51932;
			else if(c == "UTF8" || c == "UTF-8")
				return 65001;
...
// -------------------------------------------------------------------------- //
	...
	// ToUTF16Converter
	// -------------------------------------------------------------------------- //
	ToUTF16Converter::ToUTF16Converter(const char* encoding): impl(new detail::ToUTF16ConverterImpl(encoding)) {}
	...
	// FromUTF16Converter
	// -------------------------------------------------------------------------- //
	FromUTF16Converter::FromUTF16Converter(const char* encoding): impl(new detail::FromUTF16ConverterImpl(encoding)) {}
